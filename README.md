# Project 2 - *Simple Twitter2*

**Simple Tweet2** is an android app that allows a user to view his Twitter timeline. The app utilizes [Twitter REST API](https://dev.twitter.com/rest/public).
...
<img src='SimpleTweet2Walkthrough.gif' width='' alt='Video Walkthrough' />
